...
1. Kunjungi halaman [Releases](https://github.com/makcrtve/universal-discord-rpc/releases).
...
Jika ada software favorit Anda yang logo atau statusnya ingin dibuat lebih spesifik, silakan ajukan melalui [Software Request Template](https://github.com/makcrtve/universal-discord-rpc/issues/new/choose).
